 ...
 * Default: only when the PDF has no text layer at all (pure scan).
 * DS_ATTACH_FORCE_OCR=1 always OCRs (higher quality, much slower for scans).
 * DS_ATTACH_TEXTLAYER_ONLY=1 never OCRs.
 */
